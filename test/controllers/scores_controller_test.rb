...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { id_assign: @score.id_assign, title: @score.title } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { id_assign: @score.id_assign, title: @score.title } }
