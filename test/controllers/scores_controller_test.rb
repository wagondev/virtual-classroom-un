...
class ScoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create score" do
    assert_difference('Score.count') do
      post scores_url, params: { score: { inscription_id: @score.inscription_id, value_score: @score.value_score } }
    end
  ...
  test "should update score" do
    patch score_url(@score), params: { score: { inscription_id: @score.inscription_id, value_score: @score.value_score } }
