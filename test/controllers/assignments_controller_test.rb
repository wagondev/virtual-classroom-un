...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { percent: @assignment.percent, title: @assignment.title } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { percent: @assignment.percent, title: @assignment.title } }
